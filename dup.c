	...
	if(newnode!=NULL)
	{
				...
				fp=fopen(filename,"w");	
					...
					{	
									...
									{
										if(strcmp(ptr->account_holder_name,newnode->account_holder_name)==0)
										{
													if(ptr->branch_id==newnode->branch_id)
													{
													...
													else if(ptr->branch_id>newnode->branch_id)
													{
																			if(prev==ptr)
																			{
																				newnode->next=ptr;
										...
										else if(strcmp(ptr->account_holder_name,newnode->account_holder_name)>0)
										{
																			if(prev==ptr)
																			{
																				newnode->next=ptr;
